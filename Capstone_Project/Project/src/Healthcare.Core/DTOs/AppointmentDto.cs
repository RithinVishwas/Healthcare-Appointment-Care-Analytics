// File: src/Healthcare.Core/DTOs/AppointmentDto.cs
...
{
    /// <summary>AppointmentDto belongs to the healthcare layered architecture and keeps responsibilities separated.</summary>
