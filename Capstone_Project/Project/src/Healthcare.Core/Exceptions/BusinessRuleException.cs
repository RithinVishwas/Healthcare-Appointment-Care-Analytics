// File: src/Healthcare.Core/Exceptions/BusinessRuleException.cs
...
{
    /// <summary>BusinessRuleException belongs to the healthcare layered architecture and keeps responsibilities separated.</summary>
