// File: src/Healthcare.Core/Interfaces/IAnalyticsReportService.cs
...
{
    /// <summary>Defines the contract for IAnalyticsReportService; controllers/services depend on this abstraction instead of a concrete class.</summary>
    public interface IAnalyticsReportService
    {
        Task<AnalyticsSummaryDto> GetSummaryAsync();
        Task<IReadOnlyList<DepartmentAppointmentReportDto>> GetDepartmentAppointmentReportAsync();
    }
}
