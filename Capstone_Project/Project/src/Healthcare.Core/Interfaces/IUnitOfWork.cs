// File: src/Healthcare.Core/Interfaces/IUnitOfWork.cs
...
{
    /// <summary>Defines the contract for IUnitOfWork; controllers/services depend on this abstraction instead of a concrete class.</summary>
    public interface IUnitOfWork
    {
        ...
        Task<int> SaveChangesAsync(string performedBy);
    }
}
